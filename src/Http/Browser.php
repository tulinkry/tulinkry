	...
	public static function detect()
	{
		...
		foreach (self::$browsers as $_browser) {
			if (preg_match("/($_browser)[\/ ]?([0-9.]*)/", $userAgent, $match)) {
				...
				return Nette\ArrayHash::from($browser);
			}
		}
